...
# yay
yes | sudo pacman -S base-devel dust duf exa starship sheldon zsh ripgrep npm unzip wget bottom procs inetutils dnsutils sshpass bat diskonaut tree-sitter-cli
